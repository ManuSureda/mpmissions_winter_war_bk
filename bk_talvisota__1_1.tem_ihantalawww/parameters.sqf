...
SAC_GEAR_O_G_loadoutProfile = "china_50_winter"; 
GEAR_NVG = false; 
AMB_IED = true; 
CTS_ON = false; 
AMB_ON = true; 
...
COP_TAC_responseTypesSquematicMilitia = ["INF_FOOT", 70, "VEHICLE_ARMOR_TANK", 30];
...
COP_MTS_trafficTypesSquematic = ["UNARMED", 20, "ARMED_SOFT", 1, "APC", 1]; // CAMBIAAAAR "UNARMED", 20, "ARMED_SOFT", 10, "APC", 5
...
*mensaje de radio*<br/><br/>
HQ: llegan reportes de combates en todo el frente, algo serio está pasando…<br/>
mantengan la línea a toda costa y esperen órdenes.
</t>";
...
*mensaje de radio*<br/>
HQ: Cancelen todas las ordenes previas, se trata de una gran ofensiva. <br/>
Mantengan la línea y si la pierden, recupérenla hasta que se ordene lo contrario!!!
</t>";
...
*mensaje de radio*<br/>
HQ: Retirada!<br/><br/>
Abandonen la línea María y reagrúpense en Elizabeth.
</t>";
...
*mensaje de radio*<br/>
HQ: La situación es crítica, el batallón se encargara de cubrir la retirada de la división, encárguense de establecer puntos de demora y retener al enemigo todo lo que puedan, no esperen refuerzos ni apoyo blindado, el apoyo aéreo también se encuentra fuera de servicio por el clima.<br/><br/>
Buena suerte
</t>";
