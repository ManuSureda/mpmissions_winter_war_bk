...
switch (SAC_UDS_unitsProfile) do {
	...
	case "syrian_army_altis_uds": {
		...
		SAC_UDS_O_G_Soldiers = [
			...
			"LOP_SYR_Infantry_Rifleman",
			"LOP_SYR_Infantry_Rifleman"
		]; // LOP_SYR_Infantry_Rifleman_2 = fusilero automatico 
		   // LOP_SYR_Infantry_Corpsman = medic
		SAC_UDS_O_G_AA_Soldiers = ["LOP_SYR_Infantry_Rifleman"];

		// LOS ZOMBIES SALEN DE INDEPENDIENTE > WBK Zombies > civilian zombies
		// dejo solo el runner, por q si se genera una patrulla con un crawler
		// como SL, todos los demas zombies lo van a seguir en fila re deformes y lento
		SAC_UDS_O_Soldiers = [
			"Zombie_G_RA_Civ"
		];
		...
		SAC_UDS_O_HeliPilot = "Zombie_G_RA_Civ";
		SAC_UDS_O_TankCrews = ["Zombie_G_RA_Civ"];
	...
	case "sov_w_39": {
		...
		SAC_UDS_O_G_HeliPilot = "O_NORTH_SOV_T_W_39_Crewman"; 
		SAC_UDS_O_G_TankCrews = [
			"O_NORTH_SOV_T_W_39_Crewman", 
			"O_NORTH_SOV_T_W_39_Officer_Lt", 
			"O_NORTH_SOV_T_W_39_Officer"
		];

		SAC_UDS_O_HeliPilot = "O_NORTH_SOV_T_W_39_Crewman";
		SAC_UDS_O_TankCrews = [
			"O_NORTH_SOV_T_W_39_Crewman", 
			"O_NORTH_SOV_T_W_39_Officer_Lt", 
			"O_NORTH_SOV_T_W_39_Officer"
...
switch (SAC_UDS_O_G_vehicleProfile) do {
	...
	case "syrian_army_altis_uds_V_G": {
		...
		//los vehiculos que usa el modulo de refuerzos para el combate cuando sale "VEHICLE_NOARMOR"
		SAC_UDS_O_G_armedTransport = SAC_UDS_O_G_unarmedTransport + ["rhsgref_BRDM2_HQ_msv","rhsgref_BRDM2_HQ_msv","rhsgref_BRDM2_HQ_msv"];
		...
		SAC_UDS_O_G_trafficUnarmed = SAC_UDS_O_G_unarmedTransport + [
			"LOP_SYR_KAMAZ_Fuel",
			"LOP_SYR_KAMAZ_Repair",
			"LOP_SYR_KAMAZ_Medical"
		];
	...
	case "sov_w_39_V_G": {
		...
		//technicals (vehiculos sin blindaje con capacidad de fuego)
		SAC_UDS_O_G_patrolVeh = [
			"NORTH_SOV_W_39_ZIS5_Maxim_Quad", 
			"NORTH_SOV_W_39_BA6", 
			"NORTH_SOV_W_39_BA3", 
			"NORTH_SOV_W_39_BA10", 
			"NORTH_SOV_W_39_T20"
		...
		//transporte de tropas + log�stica
		SAC_UDS_O_G_trafficUnarmed = SAC_UDS_O_G_unarmedTransport + [
			"NORTH_SOV_W_39_ZIS5_Repair", 
			"NORTH_SOV_W_39_ZIS5_Medical", 
			"NORTH_SOV_W_39_ZIS5_Fuel", 
			"NORTH_SOV_W_39_ZIS5_Ammo", 
