////////////////////////////////////////////////////////
// GUI EDITOR OUTPUT START (by Sebastian, v1.063, #Kinefe)
////////////////////////////////////////////////////////
//--- PasswordControl
...
////////////////////////////////////////////////////////
// GUI EDITOR OUTPUT START (by Sebastian, v1.063, #Fonibi)
////////////////////////////////////////////////////////

class SAC_passwordControl: RscControlsGroup
{
	//idc = 2300;
	idd = 3000;
	...
	class Controls
	{
		...
		class RscEdit_1400: RscEdit
		{
			...
			onKeyUp = "if (((_this select 1) == 28) || ((_this select 1) == 156)) then {sac_password_response = [ctrlText 1600, ctrlText 1400];(ctrlParent (_this select 0)) closeDisplay 1;}";
		};
		class RscButton_1600: RscButton
		{
			idc = 1600;
			text = "Proceder"; //--- ToDo: Localize;
			...
			colorFocused[] = {0.4,0.4,0.4,1}; //siempre igual que colorBackground
			colorBackgroundActive[] = {0.4,0.4,0.4,1};
			onButtonClick = "sac_password_response = [ctrlText (_this select 0), ctrlText 1400];(ctrlParent (_this select 0)) closeDisplay 1;";
		};
		class RscButton_1601: RscButton
		{
			...
			colorFocused[] = {0.4,0.4,0.4,1}; //siempre igual que colorBackground
			colorBackgroundActive[] = {0.4,0.4,0.4,1};
			onButtonClick = "sac_password_response = [ctrlText (_this select 0), ctrlText 1400];(ctrlParent (_this select 0)) closeDisplay 2;";
		};
